({
    ...
    currentWeekDates: function(component, Datevalue) {
        ...
        console.log('projectId::', component.get("v.selectedproject").Id);
        console.log('selectedTradetypeId::', component.get("v.selectedTradetype").Id);
        console.log('selectedcontactId::', component.get("v.selectedContact").Id);
        action.setParams({
