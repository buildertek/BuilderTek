({
	...
	send:function(component, event, helper) {
        // debugger; 
		var to, cc, selectedVendorResources, toIds = [], selectedVendorResourcesIds = [], ccIds = [], files, fileIds = [], subject, body, recordId, templateId, pdfFileName;
        ...
        try {
            ...
            selectedVendorResources = component.get("v.selectedVendorResources")
            var emailIds = component.get("v.emailIds");
            to.forEach(function(v){ toIds.push(v.Id) });
            cc.forEach(function(v){ ccIds.push(v.Id) }); 
            selectedVendorResources.forEach(function(v){ selectedVendorResourcesIds.push(v.Id) }); 
        ...
        dbAction.setParams({
            ...
            emailIds: emailIds,
            vendorResourceIds: selectedVendorResourcesIds
        });
        dbAction.setCallback(this, function (response) {
        //    debugger;
            var state = response.getState();
