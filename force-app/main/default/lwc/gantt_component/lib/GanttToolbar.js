...
import { convertJSONtoApexData,setResourceDataForApexData, checkForWeekend } from "../gantt_componentHelper";
export default base => class GanttToolbar extends base {
    ...
    onStartDateChange({ value, oldValue }) {
        ...
        value = checkForWeekend(value);
        this.gantt.callGanttComponent.projectStartDateUpdateTaskData(this.gantt.taskStore, value, oldValue);
